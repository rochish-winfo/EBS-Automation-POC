...
Creating Invoice 
    ...
    # RPA.Desktop.Press Keys    tab
    # RPA.Desktop.Press Keys    tab
    Ebs Type Text    PO Number    16883
    RPA.Desktop.Press Keys    tab
    Ebs Type Text    Invoice Date    11-MAR-2022
    Ebs Type Text    Invoice Num    PO-16888888
    Ebs Type Text    Invoice Amount Required   1000
    # Ebs Click Button    Match
    # Ebs Click Button    Find
    # Ebs Click Check Box    Match
    # Ebs Click Button    Match
    # Ebs Click Button    Calculate Tax
    # ${Total}=    EBS Get Element Text    Total
    # Ebs Type Text    Invoice Amount Required   ${Total}
    # Ebs Click Button    Actions
    # Ebs Click Check Box    Validate
    # Ebs Click Button    OK
    # Ebs Select Menu     View    Requests
