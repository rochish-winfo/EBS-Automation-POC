...
Create Purchasing Requistion Summary
    ...
    RPA.JavaAccessBridge.Type Text    Requisition    16632
    RPA.JavaAccessBridge.Click Push Button    Find
    Sleep    5s
    Application Refresh
    ${Requisition}=    RPA.JavaAccessBridge.Get Element Text    Requisition
    RPA.JavaAccessBridge.Click Element    role|check box
    RPA.JavaAccessBridge.Click Push Button    Automatic
    Sleep    5s
    Application Refresh
    RPA.JavaAccessBridge.Type Text    Document    ${Requisition}    clear=True
